...
fn update_scoreboard(
    ...
    mut query: Query<Entity, With<ScoreboardUi>>
) {
    //let mut text = query.single_mut();
    //text.sections[1].value = score.to_string();
    let entity = query.single();
    *writer.text(entity, 1) = score.to_string();
}
...
fn initcreate(
    ...
    let mut projection1 = OrthographicProjection::default_2d();
    ...
    commands.spawn((
        ...
        Transform::from_translation(Vec3::new(100.,50., 1.)),
        MeshMaterial2d(materials.add(Color::srgba_u8(190, 107, 107, 255)))
    ...
    */
    ...
    commands.spawn((
        Sprite {
            image: asset_server.load("branding/32ball.png"),
    ...
    commands.spawn((Sprite {
        image: asset_server.load("branding/32base.png"),
        ..default()
    },
    Transform::from_translation(vec3(-160., 0., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    ...
    Transform::from_translation(vec3(-160., 32., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    Transform::from_translation(vec3(-160., 64., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    commands.spawn((Sprite {
        image: asset_server.load("branding/32top.png"),
        ..default()
    },
    Transform::from_translation(vec3(-160., 96., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    commands.spawn((Sprite {
        image: asset_server.load("branding/32blank.png"),
        ..default()
    },
    Transform::from_translation(vec3(-160., -96., 10.)),
    //RigidBody::Static,
    ...
    Transform::from_translation(vec3(-128., 96., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    Transform::from_translation(vec3(-96., 96., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    Transform::from_translation(vec3(-64., 96., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    commands.spawn((Sprite {
        image: asset_server.load("branding/32top1.png"),
        ..default()
    },
    Transform::from_translation(vec3(-32., 96., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    commands.spawn((Sprite{
        image: asset_server.load("branding/32top2.png"),
        ..default()
    },
    Transform::from_translation(vec3(0., 96., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    commands.spawn((Sprite {
        image: asset_server.load("branding/32top3.png"),
        ..default()
    },
    Transform::from_translation(vec3(32., 96., 10.)),
    //RigidBody::Static,
    ...
    //右边
    commands.spawn((Sprite {
        image: asset_server.load("branding/32right.png"),
        ..default()
    },
    Transform::from_translation(vec3(160., 64., 10.)),
    //RigidBody::Static,
    ...
    Transform::from_translation(vec3(192., 0., 10.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    Transform::from_translation(vec3(224., 0., 0.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    Transform::from_translation(vec3(192., -64., 0.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
    ...
    Transform::from_translation(vec3(224., -64., 0.)),
    //RigidBody::Static,
    //Collider::rectangle(32.,32.), 
    //DebugRender::default().with_collider_color(Color::srgb(1.0, 1.0, 0.0))
    ))
